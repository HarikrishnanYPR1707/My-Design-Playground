const page = () => {
  return (
    <div className="flex h-screen items-center justify-center">
      <div className="relative flex h-[350px] w-[350px] items-center justify-center overflow-hidden rounded-full p-1">
        <div className="h-full w-full overflow-hidden rounded-full border bg-[#252525] p-4">
          <div className="h-full w-full overflow-hidden rounded-full border bg-[#252525]">
            <img src="./myImage.jpg" alt="myImage" className="" />
          </div>
        </div>
        <div className="animate-spin-slow absolute -z-10 h-[500px] w-[250px]">
